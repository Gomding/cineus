...
<div class="center-home-div">
	<ul class="container center-home">
		<h5 class="center-text font-weight-bold">회원가입</h5>
	</ul>
...
<div class="container" id="mar">
	<div class="form-group">
          <form action="${pageContext.request.contextPath}/members/MemberSignUp.me" method="post" onsubmit="return emailCheck();">
		    ...
		    <div class="form-group">
		      <div class="input-group">
		        <input type="text" class="form-control" onblur="emailCheck();" id="useremail" name="useremail" style="margin-right: 0px;" required>
            ...
            <div class="form-group text-center">
              <button type="button" style="width: 137px; height: 52px;" class="btn btn-secondary" onclick="history.go(-1)">가입취소</button> 
              <button type="submit" style="width: 137px; height: 52px;" class="btn btn-primary2">회원가입</button>
            </div>
          </form>
        </div>
</div>   
