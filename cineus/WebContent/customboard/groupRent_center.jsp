...
<div class = "container-board width-fixed">
	...
	<h2 class = "cu30"><span class = "sub-title customer st2">단체관람 및 대관문의</span></h2>
	<div class = "center1on1_container-board">
		...
		<div class = "customer_term_wrap">
			<div class = "customer_term_text">
				...
				개인정보의 수집 및 이용목적<br>
				회사는 단체관람 및 문의내역의 확인, 요청사항 처리 또는 완료 시 원활한 의사소통 경로 확보를 위해 수집하고 있습니다.<br><br>
		...
		<form action = "${contextPath}/customerboard/write_groupRentCenter.do" name = "send1on1Form" method = "post" onsubmit = "return formCheck();">
			...
			<div id = "center1on1Register" class = "form-style">
				<table class = "form-table" summary = "1:1 문의">
					...
					<tbody>
						<tr>
							<th scope="row" id="th_1on1input_tel">영화관</th>
						...
						<tr>
							<th scope="row"><label for="date">관람/대관일</label>
							</th>
								<td colspan="3">
									 <div class="input-group date">
           								 <input type="text" id = "datepicker" value = "" disabled>
           								 <input type="hidden" name = "group_rent_date" id = "group_date" value = "">
           								 <i class="input-group-addon glyphicon glyphicon-calendar" style="background:none;border:none;position:relative;right:360px;top:0px;"></i>
        								<select name = "rent_time" class = "select1on1" id = "timeSelect" style = "position: relative;right: 360px;width: 80px;">
						...
						<tr>
							<th scope="row" id="th_1on1input_film">관람할 영화</th>
							<td headers="th_1on1input_film" colspan="3">
								<input type="text" title="관람할영화" id="center-grouprent-film" name="group_rent_film" style="width: 750px;" maxlength="30" fieldname="관람할영화" required="">
							</td>
						</tr>
						<tr>
							<th scope = "row" id = "th_1on1input_name"><label for = "center-grouprent-num">관람인원</label></th>
							<td headers="th_1on1input_group_num" colspan="3">
							<input type="text" title="관람인원" class = "a-r pr10" id="center-grouprent-num" name="group_rent_totalnum" value="" maxlength="20" allowtype="hangul alphabet special" fieldname="관람인원" required=""> 명
							</td>
						</tr>
						<tr>
...
<!-- 								<p class = "text-sub mt7" id = "wordCheckCount">자</p> -->
	...
	function formCheck() {
		...
		var group_rent_date = document.getElementById("group_date");
		var timeSelect = document.getElementById("timeSelect");
		
		group_rent_date.value = datepicker.value;
		...
		if (group_rent_date.value == "") {
			alert("영화관람 날짜를 선택하셔야합니다.");
			group_rent_date.focus();
			return false;
		}
		if(timeSelect.value = "") {
			alert("영화관람 시간을 선택하셔야합니다.")
			timeSelect.focus();
			return false;
		}
